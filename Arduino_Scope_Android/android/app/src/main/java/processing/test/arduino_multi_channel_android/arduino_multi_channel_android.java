package processing.test.arduino_multi_channel_android;
...
public class arduino_multi_channel_android extends PApplet {
...
public void setup() 
{
  ...
  drawch();
  drawpb();
  //println(Serial.list(this)[0]);
  //println(Serial.list(this)[1]);
  //println(Serial.list()[2]);
  //port = new Serial(this, Serial.list()[1], 38400);
  //port = new Serial(this, Serial.list()[1], 57600);
  port = new Serial(this, Serial.list(this)[0], 115200); // WE NEED TO ADD USER INTERFACE DROPDOWN FOR THIS
}
...
public void drawpb(){
  ...
  fill(255); stroke(255);
  f = createFont("SansSerif", 16 * displayDensity);
  textFont(f);
  textAlign(LEFT);
